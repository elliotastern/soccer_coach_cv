...
from src.mapping.pitch_landmarks import LandmarkDatabase, Landmark
from src.mapping.line_clustering import merged_lines_and_intersection_keypoints
...
class PitchKeypointDetector:
    ...
    def __init__(self, pitch_length: float = 105.0, pitch_width: float = 68.0, 
        ...
        if use_semantic_segmentation:
            try:
                from src.mapping.pitch_line_segmentation import PitchLineSegmenter
    ...
    def _detect_goals_zero_shot(self, image: np.ndarray) -> List[PitchKeypoint]:
        ...
        if self._zero_shot_detector is None:
            try:
                from src.mapping.zero_shot_goal_detector import ZeroShotGoalDetector
